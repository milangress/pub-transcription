...
function simulatedTranscriptController(mainWindow, SendMessageEvery = 1800, balance = 0.2) {
    ...
    const naturalPhrases = [
        // Complete thoughts
        "I hope you all enjoyed that", "Let's continue with some questions", 
        "Maybe we can talk about this", "That's an interesting point",
        "Let's move on to the next topic", "I would like to ask you",
        "Can you tell us more about that", "What do you think about",
        ...
        "Well that's exactly how", "Back to our previous point",
        "Speaking of which", "As I was saying before",
        "Moving on to", "Interesting perspective on",
        
        // Radio show specific
        "We're going to continue with some music now",
        "Let's take a short break", "Back after these messages",
        "Thanks for joining us today", "Coming up next",
        
        // Filler and thinking phrases
        "Um", "Well", "You know", "I mean", "Actually",
        "Sort of", "Kind of", "Like", "So basically",
