...
const { simulatedTranscriptController } = require('./simulateTranscriptForDevTesting')
const { createStreamProcess } = require('./streamProcess')
const { AudioRecorder } = require('./audioRecorder')
const { PRINT_ACTIONS, PRINT_STATUS, createPrintStatusMessage } = require('./printMessages')
...
function createWindow() {
  ...
  ipcMain.handle('execute-print', async (event, { content, settings = {} }) => {
    try {
      ...
      sendToAllWindows(
        'print-status',
        createPrintStatusMessage(settings.printId, PRINT_ACTIONS.PRINT_START, PRINT_STATUS.INFO, {
      ...
      sendToAllWindows(
        'print-status',
        createPrintStatusMessage(settings.printId, PRINT_ACTIONS.PDF_SAVE, PRINT_STATUS.SUCCESS, {
      ...
      sendToAllWindows(
        'print-status',
        createPrintStatusMessage(settings.printId, PRINT_ACTIONS.PRINT_ERROR, PRINT_STATUS.ERROR, {
